...
var CSS="*{box-sizing:border-box;margin:0;padding:0}body{font-family:Inter,Arial,sans-serif;color:#1a1a2e}.nav{background:#fff;border-bottom:1px solid #e5e7eb;padding:.75rem 1rem;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:100}.logo{font-size:1.1rem;font-weight:800;color:#0f4c5c}.logo span{color:#f97316}.nl{display:flex;gap:1.5rem}.nl a{color:#4b5563;font-size:.85rem;font-weight:500;cursor:pointer;text-decoration:none}.ncta{background:#f97316;color:#fff;border:none;padding:.5rem 1rem;border-radius:.4rem;font-weight:700;cursor:pointer;font-size:.85rem;white-space:nowrap}.hero{position:relative;min-height:420px;overflow:hidden;display:flex;align-items:stretch;background:#f8fafc}.hi{position:absolute;inset:0;z-index:1}.hi img{width:100%;height:100%;object-fit:cover;object-position:right center}.hf{position:absolute;inset:0;z-index:2;background:linear-gradient(to right,rgba(248,250,252,1) 0%,rgba(248,250,252,.98) 45%,rgba(248,250,252,.7) 65%,transparent 100%)}.hb{position:relative;z-index:3;width:55%;padding:2.5rem 1.5rem 2.5rem 2rem;display:flex;flex-direction:column;justify-content:center}.hb h1{font-size:1.9rem;font-weight:900;line-height:1.15;color:#0f4c5c;margin-bottom:.9rem}.hb h1 em{color:#f97316;font-style:normal}.hb p{font-size:.9rem;color:#374151;margin-bottom:1.4rem;line-height:1.6}.btn{background:#f97316;color:#fff;border:none;padding:.85rem 1.8rem;border-radius:.5rem;font-size:.95rem;font-weight:700;cursor:pointer;display:inline-flex;align-items:center;gap:.4rem}.btn:hover{background:#ea6c00}.trust{display:flex;gap:.8rem;margin-top:1.1rem;flex-wrap:wrap}.trust span{font-size:.75rem;color:#374151;font-weight:500}.tw{background:#fff;border-top:1px solid #e5e7eb;border-bottom:1px solid #e5e7eb;padding:.8rem 0;overflow:hidden}.ticker{display:flex;gap:1rem;animation:sc 35s linear infinite;width:max-content}.ticker:hover{animation-play-state:paused}@keyframes sc{0%{transform:translateX(0)}100%{transform:translateX(-50%)}}.lc{display:flex;align-items:center;justify-content:center;width:120px;height:48px;overflow:hidden;flex-shrink:0}.lc img{max-height:32px;max-width:100px;width:auto;height:auto;object-fit:contain}.sec{padding:3rem 1.5rem;max-width:860px;margin:0 auto}.st{font-size:1.7rem;font-weight:800;color:#0f4c5c;margin-bottom:.5rem}.ss{color:#6b7280;margin-bottom:2rem}.card{background:#fff;border-radius:1rem;box-shadow:0 4px 24px rgba(0,0,0,.08);padding:2rem;max-width:580px;margin:0 auto}.fi{margin-bottom:1.2rem}.fi label{display:block;font-weight:600;color:#374151;margin-bottom:.4rem;font-size:.9rem}.fi select,.fi input{width:100%;padding:.65rem .9rem;border:1.5px solid #d1d5db;border-radius:.5rem;font-size:.95rem;color:#1a1a2e;outline:none}.fi select:focus,.fi input:focus{border-color:#0f4c5c}.sb{width:100%;background:#f97316;color:#fff;border:none;padding:.9rem;border-radius:.5rem;font-size:1rem;font-weight:700;cursor:pointer;margin-top:.4rem}.sb:hover{background:#ea6c00}.stamp{font-size:2rem;font-weight:900;letter-spacing:.12em;padding:.7rem 1.8rem;border:4px solid;border-radius:.5rem;display:inline-block;margin:1rem 0;text-transform:uppercase}.bw{margin:1.4rem 0}.bar{height:11px;background:#e5e7eb;border-radius:6px;overflow:hidden}.bf{height:100%;border-radius:6px;transition:width 1s}.sav{background:#f0fdf4;border:1px solid #bbf7d0;border-radius:.75rem;padding:1.4rem;margin:1.4rem 0;text-align:center}.sav h3{color:#16a34a;font-size:1rem;font-weight:700;margin-bottom:.3rem}.amt{font-size:1.4rem;font-weight:800;color:#0f4c5c}.lf{text-align:left;margin-top:2rem}.lf h3{font-size:1rem;font-weight:700;color:#0f4c5c;margin-bottom:1rem}.steps{display:grid;grid-template-columns:repeat(3,1fr);gap:1.5rem;margin-top:2rem}.step{text-align:center}.sn{width:44px;height:44px;background:#0f4c5c;color:#fff;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:1.1rem;font-weight:800;margin:0 auto 1rem}.step h3{font-weight:700;color:#0f4c5c;margin-bottom:.35rem;font-size:.95rem}.step p{color:#6b7280;font-size:.85rem}.ft{background:#0f4c5c;color:rgba(255,255,255,.7);padding:2rem;text-align:center;font-size:.82rem}.ft strong{color:#fff}@media(max-width:480px){.hb{width:58%;padding:2rem 1rem 2rem 1.2rem}.hb h1{font-size:1.35rem}.hb p{font-size:.8rem;margin-bottom:1rem}.btn{padding:.7rem 1.2rem;font-size:.85rem}.trust span{font-size:.7rem}.hero{min-height:320px}.nl{display:none}.steps{grid-template-columns:1fr}}";
    ...
    {pg==="home"&&<>
      <div className="hero">
        ...
        <div className="hb">
          ...
          <div className="trust"><span>&#10003; 100% free</span><span>&#10003; No obligation</span><span>&#10003; Updated monthly</span></div>
        </div>
      </div>
      <div className="tw">
